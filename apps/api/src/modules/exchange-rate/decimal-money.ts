...
/** Normalizes a positive decimal rate without introducing binary float noise. */
...
/** Converts minor units with integer arithmetic and half-up rounding. */
...
/** Produces a reciprocal rate with a bounded decimal precision. */
