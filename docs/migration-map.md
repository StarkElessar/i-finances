...
| `src/views`, `src/widgets`, `src/shared/ui` | `apps/web` | partial | New Solid shell, category read view, and minimal account CRUD/archive view exist; legacy screens remain intentionally unmigrated. |
